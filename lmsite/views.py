...
def home(request):
    offer_list = Offer.objects.exclude(is_custom_offer=True)
    context = {
...
def make_payment(request):
    try:
        ...
        if str_offer_id == "-1":
            offer = Offer.objects.create(name="Goodies at the Venue",
                                         description="This QR code entitles you to get a goodie",
                                         free_units=100,
                                         total_cost=1000,
